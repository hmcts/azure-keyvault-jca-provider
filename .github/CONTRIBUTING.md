...
This project is a JCA bridge to [Azure Key Vault](https://azure.microsoft.com/en-us/services/key-vault/). 
It provides access to Azure's Key Vault service via standard Java JCA/JCE APIs.
